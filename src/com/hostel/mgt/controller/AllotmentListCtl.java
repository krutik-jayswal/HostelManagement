...
/*  39 */     log.debug("AllotmentListCtl populateBean method start");
/*  40 */     AllotmentBean bean = new AllotmentBean();
/*     */     
/*  42 */     bean.setName(DataUtility.getString(request.getParameter("name")));
/*     */     
/*  44 */     log.debug("AllotmentListCtl populateBean method end");
...
/*  52 */     log.debug("AllotmentListCtl doGet Start");
/*  53 */     List list = null;
/*     */     
/*  55 */     int pageNo = 1;
/*     */     
...
/*     */     
/*  59 */     AllotmentBean bean = (AllotmentBean)populateBean(request);
/*     */     
...
/*     */     
/*  66 */     AllotmentModel model = new AllotmentModel();
/*     */     
/*     */     try {
...
/*     */       return;
/*     */     } 
/*  94 */     log.debug("AllotmentListCtl doPOst End");
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 101 */     log.debug("AllotmentListCtl doPost Start");
/*     */     
/* 103 */     List list = null;
...
/*     */     
/* 110 */     AllotmentBean bean = (AllotmentBean)populateBean(request);
/*     */     
...
/*     */     
/* 117 */     AllotmentModel model = new AllotmentModel();
/*     */     
/*     */     try {
...
/* 136 */             AllotmentBean deletebean = new AllotmentBean(); byte b; int i; String[] arrayOfString;
...
/* 146 */           ServletUtility.redirect("/Hostel-Management/ctl/allotmentList", request, response);
/*     */           
/*     */           return;
/*     */         } 
/*     */       } 
...
/*     */       return;
/*     */     } 
/* 176 */     log.debug("AllotmentListCtl doGet End");
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   protected String getView() {
/* 182 */     return "/jsp/AllotmentListView.jsp";
/*     */   }
/*     */ }


/* Location:              C:\Users\jayswkru\Documents\mahima\Mos-Hostel-Management\WEB-INF\classes\com.jar!\com\hostel\mgt\controller\AllotmentListCtl.class
