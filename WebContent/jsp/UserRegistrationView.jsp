...
<div class="col-md-5">
    <div class="form-area">  
       ...
       <jsp:useBean id="bean" class="com.hostel.mgt.bean.UserBean"
        ...
        <br style="clear:both">
                    <h3 style="margin-bottom: 15px; text-align: left;">Registration</h3><b style="color:red;">(All fields are mandatory*)</b>
                		...
                		<div class="form-row">
							...
							<div class="form-group">
								<input type="text" class="form-control"  name="login"
									placeholder="Email/login Id" value="<%=DataUtility.getStringData(bean.getLogin())%>" > 
						...
						<font   color="red"> <%=ServletUtility.getErrorMessage("confirmPassword", request)%></font>
							...
							<div class="form-group">
								<input type="text" class="form-control"  name="mobile"
									placeholder="Mobile No.(Without country code)" value="<%=DataUtility.getStringData(bean.getMobileNo())%>" > 
							...
							<div class="form-group">
								<input type="text" class="form-control" id="datepicker" name="dob"
									placeholder="Date Of Birth (DD/MM/YYYY)" value="<%=DataUtility.getDateString(bean.getDob())%>" > 
