...
<div class="col-md-5">
    <div class="form-area">  
       ...
       <jsp:useBean id="bean" class="com.hostel.mgt.bean.UserBean"
        ...
        <br style="clear:both">
                    <h3 style="margin-bottom: 15px; text-align: left: ;">Add User</h3><b style="color:red;">(All fields are mandatory*)</b>
                		...
                		<div class="form-row">
							...
							<div class="form-group">
								<input type="text" class="form-control"  name="login"
									placeholder="Login Id/Email Id" value="<%=DataUtility.getStringData(bean.getLogin())%>" > 
