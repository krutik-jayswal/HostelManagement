...
<nav class="navbar navbar-expand-lg navbar-light " style="background-color: #fbd379;">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" href="<%=HMSView.STATIC_PAGE_CTL%>?action=r">Reports</a>
      </li>
    ...
    <form class="form-inline my-2 my-lg-0">
     ...
     <li class="nav-item dropdown">
      ...
      <li class="nav-item">
        <a class="nav-link" href="<%=HMSView.STATIC_PAGE_CTL%>?action=a">About Us</a>
      </li>
      
      <li class="nav-item">
        <a class="nav-link" href="<%=HMSView.STATIC_PAGE_CTL%>?action=c">Contact Us</a>
      </li>
